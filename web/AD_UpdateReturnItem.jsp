<%-- 
    Document   : AD_UpdateReturnItem
    Created on : Feb 2, 2021, 3:35:55 PM
    Author     : User
--%>
...
<head>
    ...
    <title>Admin Update Return Item Page</title>
    ...
    ***********************************-->
    <div id="main-wrapper">
       ...
       <div class="content-body">
        ...
        String password = "";
        String query = "SELECT * FROM reservation where UserID='"+UserID+"' and itemID='"+ItemID+"'";
        ...
        ResultSet rs = st.executeQuery(query);//5- Execute query
           ...
           while(rs.next()){//6- process the result
                 ...
                 out.println("<td align=\"center\"><form method=post>"
                         ...
                         + "<input type=\"datetime-local\" name=\"returnDate\" id=\"returnDate\"></td>"
                          +"<td><input type=\"text\" name=\"AdditionalCharges\" id=\"AdditionalCharges\"></td>"
                         +"<td><input type='submit' value='Submit' formaction='AD_UpdateReturnItem'></td>"
                         + "</form>");
                 
                 session.setAttribute("UserID",rs.getString(2));
                 session.setAttribute("ItemID",rs.getString(1));
