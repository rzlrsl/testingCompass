...
//                 list.setStock(rs.getInt(4));
           ...
           Vector itemList = (Vector)session.getAttribute("CList");
               ...
               {    
                 ...
                 //out.println("<td align=\"center\">" + List.getStock() + "</td>");
                 out.println("<td align=\"center\"> RM" + List.getPrice() + "</td>");
                 out.println("<td align=\"center\">");
                 out.println("<a href=\"description_servlet?id="+List.getId()+"&type=cassete\">details</a>");
                 out.println("</td>");
                 out.println("</tr>");
