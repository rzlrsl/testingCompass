...
<head>
    ...
    <title>PAGE TITLE</title>
     <link rel="stylesheet" type="text/css" href="style/desc_page.css">
    <!-- Favicon icon -->
       ...
       <div class="content-body">
           ...
           %>
            ...
            <%
                   ...
                   out.println("<tr rowspan=\"2\"><td><br> Stock</td><td>"+Item.getStock()+"</td></tr><br>");
                   out.println("<tr rowspan=\"2\"><td><br> Price </td><td> RM"+Item.getPrice()+"</td></tr>");
                   out.println("<tr rowspan=\"8\"><td colspan=\"2\"><p><br>"+Item.getDescription()+"</p></td></tr></table>");
                   
                   out.println("<a href=\"./reservation.jsp\">RESERVE</a>");
                   out.println("<a href=\"./addwishlist\">ADD WISHLIST</a>");
          %>
                  <!-- #/ container -->   
