           ...
           <script>
            ...
            <!-- #/ container  -->
               <%
                   ...
                   out.println("<table><tr><td> Full Name </td><td>"+profile.getFullname()+"</td></tr>");
                   out.println("<tr><td> Address </td><td>"+profile.getAddress()+"</td></tr>");
                   out.println("<tr><td> Phone Number </td><td>"+profile.getPhone_num()+"</td></tr>");
                   out.println("<tr><td> Email </td><td>"+profile.getEmail()+"</td></tr>");
                   out.println("<tr><td> Username </td><td>"+profile.getUsername()+"</td></tr>");
                   out.println("<tr><td> Password </td><td>"+profile.getPassword()+"</td></tr></table>");
                   
                   
                %>
                
        <center>
<p><a href="updateProfile.jsp">UPDATE</a>
</p>
        </center>    
        </div>
