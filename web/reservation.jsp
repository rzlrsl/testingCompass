...
<body>
        ...
        <div class="wrapper wrapper--w780">
            ...
            <%
                item Item=(item) session.getAttribute("Descip");
                        ...
                        %>
                    <form method="POST">
                        <p class="title">Reservation Info</p>
                         <div class="input-group">
                          ITEM NAME: <input type="text" name="itemName" id="itemName" placeholder="<%= Item.getName() %>"readonly/>
                         </div><br>
                        <div class="input-group">
                             Start Date (date and time):<input type="datetime-local" id="startDate" name="startDate">
                            <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                        </div><br>
                       <div class="input-group">
                             End Date (date and time):<input type="datetime-local" id="endDate" name="endDate">
                             <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i></div><br>
                            <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" formaction="insert_reservation">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
   ...
   <% // String itemname=(String) session.getAttribute("itemname");
        ...
        //  out.println("<form method=\"post\" >");
         ...
         //  out.println("<br/><br/>");               
         //  out.println(" ITEM NAME: <input type=\"text\" name=\"itemName\" id=\"itemName\"/><br/><br/>");              
           
          // out.println("Start date:"); 
          // out.println("<input type=\"datetime-local\" id=\"startDate\" name=\"startDate\"><br/><br/>"); 
            
         //   out.println("End date:");            
       //    out.println("<input type=\"datetime-local\" id=\"endDate\" name=\"endDate\"><br/><br/>"); 
        
          // out.println("  </div>   ");    
         //   out.println(" <button type=\"submit\" formaction=\"InsertReservation\">Submit</button>");   
       // out.println("</form>");
     //  out.println("</div>"); 
