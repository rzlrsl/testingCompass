    ...
    ***********************************-->
    <div id="main-wrapper">
       ...
       <div class="content-body">
           ...
           out.println("</tr>"); 
           Vector itemList = (Vector)session.getAttribute("status");
               
           if(itemList.size()>1)
           {
               for(int i=0; i<itemList.size(); i++)
               {    
                   Status status = (Status)itemList.get(i);
                 out.println("<tr>");
                 out.println("<td align=\"center\">" + status.getName() + "</td>");
                 out.println("<td align=\"center\">" + status.getType() + "</td>");
                 out.println("<td align=\"center\">" + status.getStatus() + "</td>");
                 out.println("</tr>");
           ...
           {
               out.println("<td colspan=\"3\"><br><br> ==You have Nothing==</td>");
           }
            out.println("</table>");//END OF THE TABLE
            out.println("</body>");
            out.println("</html>");
          %>
