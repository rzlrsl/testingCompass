<%-- 
    Document   : AD_TaskStatus
    Created on : Feb 1, 2021, 8:35:51 AM
    Author     : GoGoBe
--%>
...
<head>
    ...
    <title>Admin Task Status Page</title>
...
//                 list.setStock(rs.getInt(4));
           ...
           Vector itemList = (Vector)session.getAttribute("List");
               ...
               {    
                 ...
                 out.println("<td><a href='AD_UpdateTaskStatus.jsp?UserID="+List.getCustomerEmail()+"&Item_name="+List.getName()+"'>update</a></td>");
                 out.println("</td>");
                 out.println("</tr>");
